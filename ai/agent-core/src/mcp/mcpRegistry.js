import { Client } from '../../../agent-koa/node_modules/@modelcontextprotocol/sdk/dist/esm/client/index.js';
import { StdioClientTransport } from '../../../agent-koa/node_modules/@modelcontextprotocol/sdk/dist/esm/client/stdio.js';
...
export class MCPRegistry {
  constructor(initialConfigs = [], options = {}) {
    this.configs = new Map();
    this.active = new Map();
    this.clientInfo = {
      name: options.clientName || 'agent-core-host',
...
export function createMCPRegistry(initialConfigs = [], options = {}) {
  return new MCPRegistry(initialConfigs, options);
}
