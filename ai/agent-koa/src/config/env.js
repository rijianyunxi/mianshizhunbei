...
const envSchema = z.object({
  ...
  TOOL_ROUTER_KEYWORD_MIN_SCORE: z.coerce.number().int().min(0).default(1),
  TOOL_ROUTER_VECTOR_MIN_SCORE: z.coerce.number().min(0).default(0.2),
  TOOL_ROUTER_VECTOR_MIN_SCORE_IF_NO_KEYWORD: z.coerce.number().min(0).default(0.45),
